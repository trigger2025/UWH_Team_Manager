    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="fixed right-6 bottom-[calc(5rem+env(safe-area-inset-bottom))] z-50">
        <AddPlayerDialog>
          <Button 
            size="icon" 
            className="h-14 w-14 rounded-full shadow-2xl shadow-primary/40 bg-primary hover:bg-primary/90 text-primary-foreground transition-all hover:scale-110 active:scale-95"
          >
